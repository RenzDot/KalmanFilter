...
{
    /*
    Raw Data -> [raw data 1, raw data 2]
    Kalman Filter -> [UKF, Bowtie, Standard]

    */
    
    public partial class FormMenu : Form {
        public static double[] raw_data = new double[] {
            999993.937,
            999992.812,
            999988.687,
            999979.125,
